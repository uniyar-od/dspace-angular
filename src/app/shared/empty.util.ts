...
/**
 * Returns true if the passed value is null or undefined.
 * hasNoUndefinedValue();                 // true
 * hasNoUndefinedValue(null);             // true
 * hasNoUndefinedValue(undefined);        // true
 * hasNoUndefinedValue('');               // false
 * hasNoUndefinedValue({undefined, obj}); // false
 * hasNoUndefinedValue([undefined, val]); // false
 */
