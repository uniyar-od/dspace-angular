...
import { WorkspaceItemRejectedSearchResult } from '../../../object-collection/shared/workspaceitem-rejected-search-result.model';
...
@renderElementsFor(WorkspaceItemRejectedSearchResult, SetViewMode.List)
export class WorkspaceitemRejectedMyDSpaceResultListElementComponent extends MyDSpaceResultListElementComponent<WorkspaceItemRejectedSearchResult, WorkspaceItem> {
