...
export class AuthorityConfidenceStateDirective implements OnChanges {
  ...
  @Input() authorityValue: AuthorityValueModel | FormFieldMetadataValueObject | string;
  ...
  private getConfidenceByValue(value: any): ConfidenceType {
    ...
    if (isNotEmpty(value) && value instanceof AuthorityValueModel && value.hasAuthority()) {
